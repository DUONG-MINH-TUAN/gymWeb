  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        // dùng widget orientationBuilder để khi đt xoay ngang dọc có thể
        // xây dưng lại nội dung tương ứng
    ...
    return Row(
      ...
      children: <Widget>[
        Container(
            ...
            child: IntroductionScreen(//set up các thuộc tính của introduction screen
              key: introKey,
